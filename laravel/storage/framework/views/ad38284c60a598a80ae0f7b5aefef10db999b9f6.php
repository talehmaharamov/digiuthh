...
<?php $__env->startSection('title', __('third.register_as_mentor')); ?>

<?php $__env->startSection('content'); ?>
    <section class="form-section">
        <form action="<?php echo e(route('register.mentor')); ?>" method="post" class="digiuth_form" id="teacher-register"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\digiuth\laravel\resources\views/mentor.blade.php ENDPATH**/ ?>