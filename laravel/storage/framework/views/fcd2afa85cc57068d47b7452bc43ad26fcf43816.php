...
<section id="certificate_item" class="certificate_item_area fix pt-120 pb-120">
    <div class="certificate_download">
        ...
        <a class="btn btn-secondary btn-xs" href="/"><?php echo e(__('header.back')); ?></a>
                        ...
                        <div class="card_body">
                            <div class="name">
                                <img src="/assets/img/certificate/name_sign.svg" alt=""><span>
                                       <?php echo e($certificate->user->fullname ?? $certificate->user->{'fullname_' . app()->getLocale()}); ?>
...
<?php /**PATH C:\laragon\www\digiuth\laravel\resources\views/certificate.blade.php ENDPATH**/ ?>